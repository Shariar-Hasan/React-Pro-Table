...
var TableBody = function () {
    ...
    return (React.createElement(React.Fragment, null, dataList.map(function (item, index) {
        return (React.createElement("div", { className: "table__row ".concat(bordered ? "bordered" : "", " ").concat(selectable ? "selectable" : "", " ").concat(hoverable ? "hoverable" : "", " ").concat(striped ? "striped" : "", " ").concat(isSelected(item) ? "selected" : ""), key: index, onClick: function () { return handleRowClick(item, index); } },
            selectable && (React.createElement("div", { className: "table__column" },
                React.createElement(Checkbox, { item: item }))),
            headers.map(function (header, index) {
                return isColumnVisible(header) && (React.createElement("div", { className: "table__column", key: index }, header.render(item)));
            })));
    })));
};
